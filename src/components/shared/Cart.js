...
import { decrease, removeItem, increase } from "../../Redux/Cart/CartActions";
const Cart = (props) => {
      ...
      <div className="flex md:flex-row md:justify-between md:w-2/3 flex-col items-center justify-center bg-white border border-solid  rounded-md py-2 px-10 mx-3 border-gray-300 shadow-md mb-10 md:gap-14">
        ...
        <div className="flex flex-row">
          {quantity > 1 ? (
            ...
            >
              <img
                className="bg-blue-500   font-bold w-10 rounded-md p-2  animate__animated animate__fadeInUp  hover:bg-blue-700 transition-colors mx-2"
                src={trashIcon}
                alt="trash"
                width="15px"
              />
